...
{{-- <div class="form"> --}}
    <div class="formcontent">
        ...
        <form action="{{ route('print1') }}" method="post">
            @csrf
            ...
            <label for="dropdown">Template Option :</label>
                <select name="template" id="template-select">
                  ...
                  <option value="template-registrasi1">Option 1</option>
                  <option value="template-registrasi2">Option 2</option>
                  <option value="template-registrasi3">Option 3</option>
                </select>
            </div>
